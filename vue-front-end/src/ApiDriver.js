...
let baseUrl = "http://api.ycpradiotelescope.com/api/";
...
export default {
    ...
    login: function(data) {
      return axios.post("http://api.ycpradiotelescope.com/login?email=" + data.username.value + "&password=" + data.password.value, JSON.stringify(data))
    },
    logout: function () {
